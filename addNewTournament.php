...
if (isset($_POST['upload'])) {
    ...
    // Get text
    $tournament_name = mysqli_real_escape_string($db, $_POST['team_name']);
    ...
    $sql = "INSERT INTO tournaments (tournament_name,title,description,Image) VALUES ('$tournament_name','$title','$description','$image')";
    // execute query
    mysqli_query($db, $sql);
...
<div id="content">
    ...
    <div class="container mt-4 mb-5 col-8 p-3" style="border: 1px solid darkgrey;border-radius: 20px">
        ...
        <form method="POST" action="addNewTournament.php" enctype="multipart/form-data">
            <input type="hidden" name="size" value="1000000">
            <div class="form-group">
                <label>Tournament Name: </label>
                <input type="text" name="team_name" placeholder="Team Name" required value="<?php if (isset($_POST['team_name'])){echo $_POST['team_name'];} ?>" class="form-control" style="border:1px solid black; border-radius: 10px">
            </div>
            <div class="form-group">
                <label>Title: </label>
