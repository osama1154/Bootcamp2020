...
if (isset($_POST['upload'])) {
    ...
    $sql = "INSERT INTO teams (team_name,title,description,Image) VALUES ('$team_name','$title','$description','$image')";
    // execute query
    mysqli_query($db, $sql);
...
<div id="content">
    ...
    <div class="container mt-4 mb-5 col-8 p-3" style="border: 1px solid darkgrey;border-radius: 20px">
        ...
        <form method="POST" action="addNewTeam.php" enctype="multipart/form-data">
